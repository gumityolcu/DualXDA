...
#SBATCH --job-name=explanations_correlation
...
run \
      ...
      ../singularity/explanations_correlation.sif --xpl_path /mnt/explanations/$1/std --device cuda --output_path /mnt/outputs --num_test_samples 500 --corr $2
